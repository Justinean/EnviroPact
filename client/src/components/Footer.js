  ...
  return (
    <div className={classes.footerFlex}>
      ...
      <div className={classes.footer2}>
        ...
        <a className={classes.footerLink} target="_blank" rel="noreferrer" href="https://github.com/Justinean/EnviroPact"><GitHubIcon style={{ color: '#E18335', fontSize: '3rem', margin: '10px' }} /></a>
